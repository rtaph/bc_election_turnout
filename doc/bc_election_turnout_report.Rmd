...
An exploratory data analysis (EDA) can be found in the [`eda/`](https://github.com/UBC-MDS/bc_election_turnout/tree/main/eda) directory. 
...
knitr::include_graphics("../eda/bc_election_turnout_files/figure-html/pvp.png")
```
...
knitr::include_graphics("../eda/bc_election_turnout_files/figure-html/pvr.png")
```
